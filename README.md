...
- [`packages/shane-new-doc`](./packages/shane-new-doc) — the CLI itself. [npm](https://www.npmjs.com/package/shane-new-doc)
- [`packages/create-shane-new-doc`](./packages/create-shane-new-doc) — its one-command initializer, invoked via `npm create shane-new-doc@latest`. [npm](https://www.npmjs.com/package/create-shane-new-doc)
